...
from Prediction_model.model import train_model_with_weights
from Prediction_model.evaluate_model import evaluate_model
...
def prepare_single_row_features(row: pd.Series, raw_df: pd.DataFrame) -> pd.DataFrame:
    ...
    from Prediction_model.helpers import prepare_single_row_features as _prep
